...
import { TRAVAIL_CATEGORIES, PERSONNEL_CATEGORIES, cn } from '@/lib/utils'
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-100 font-sans">
      ...
      <main className="relative max-w-screen-2xl mx-auto px-4 sm:px-6 py-6 pb-24">
        ...
        {view === 'todo-travail' && (
          <TodosView state={state} stats={stats}
            ...
            onUpdate={actions.updateTodo} onToggle={actions.toggleTodo} onDelete={actions.deleteTodo}
      ...
      <QuickAddModal open={quickAddOpen} onClose={() => setQuickAddOpen(false)}
        onAddTodo={actions.addTodo} onAddDoneTodo={actions.addDoneTodo} />
