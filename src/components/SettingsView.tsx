    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="rounded-2xl border border-zinc-800 bg-zinc-900/50 p-5 space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-sm font-bold">Assistant vocal (Claude)</h2>
        ...
        <div className="rounded-xl bg-zinc-900/60 border border-zinc-800 p-4 text-[11px] text-zinc-400 leading-relaxed">
          <p className="font-semibold text-zinc-200 mb-1.5">Clé API Anthropic</p>
          <ol className="space-y-0.5 list-decimal list-inside">
            <li>Va sur <a href="https://console.anthropic.com/settings/keys" target="_blank" rel="noopener" className="text-cyan-400 underline">console.anthropic.com</a></li>
            <li>Crée une clé API</li>
            <li>Copie-la et colle-la ci-dessous</li>
          </ol>
          <p className="mt-2 text-[10px] text-zinc-500">Utilise Claude Sonnet — très peu coûteux pour un usage vocal.</p>
        </div>
